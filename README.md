...
- **clgem** — Leader Claude (Fable 5) multi-agent orchestration: the leader does
  ...
  cost-optimized models (sonnet/haiku); a separate Gemini CLI session critically
  reviews every completed task; all coordination is logged in Comm.md; work
  iterates against a /goal until acceptance criteria are met.
